...
public class DrupalPushMojoTest {
    ...
    public void execute() throws Exception {
        ...
        rootDirectoryField.set(cut, new File(this.getClass().getClassLoader().getResource("cdi-veto").getFile()).getParentFile());
